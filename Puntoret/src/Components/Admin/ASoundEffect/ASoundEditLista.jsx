...
const ASoundEditLista = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/sound/klista/` + id);
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        navigate('/soundeffect/klista')

        axios.put(`${import.meta.env.VITE_API_URL}/sound/edit_klista/` + id, employee)
            .then(result => {
                if (result.data.Status) {
                    navigate('/dashboard/soundeffect/klista')
...
export default ASoundEditLista