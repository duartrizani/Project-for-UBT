...
const AProgEditLista = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/prog/klista/` + id);
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        navigate('/dashboard/programer/klista')
