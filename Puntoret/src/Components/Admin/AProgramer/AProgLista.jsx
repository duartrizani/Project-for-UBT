  ...
  return (
    <div className="lg:px-5 mt-3 pl-2">
      ...
      <div className="flex justify-between">
        ...
        <Link to="/dashboard/programer/add_klista" className="btn btn-success ">
          Shto Listë
        </Link>
          ...
          <tbody className="text-center">
            {sortedFilteredWorker.map((e) => (
              <tr key={e.id}>
                ...
                <td>
                  <Link
                    to={`/dashboard/programer/edit_klista/${e.id}`}
                ...
                {activeDropdown === e.id && (
                  <>
                    ...
                    <tr className="flex items-center text-wrap justify-between">
                      ...
                      <td className="flex justify-end">
                        <Link to={`/dashboard/programer/edit_klista/` + e.id} className="btn btn-info btn-sm me-2">
                          Edit
                        </Link>
                        <button
