...
const AKEmployee = () => {
  ...
  return (
    <div className="lg:px-5 mt-3 pl-2">
      ...
      <Link to="/dashboard/gamedesign/add_employee" className="btn btn-success ">
        Shto Puntorë
      </Link>
          ...
          <tbody className="text-center">
            {employee.map((e, index) => (
              <tr>
                ...
                <td>
                  <Link
                    to={`/dashboard/gamedesign/oret/` + e.worker_id}
                    className="btn btn-primary btn-sm me-2"
                  >
                    Orët
                  </Link>
                  <Link
                    to={`/dashboard/gamedesign/edit_employee/` + e.worker_id}
            ...
            <>
              ...
              <tr className="flex items-center text-wrap justify-between">
                ...
                <td className="flex justify-end">
                  <Link to={`/dashboard/gamedesign/oret/` + e.worker_id} className="btn btn-primary btn-sm me-2">
                    Orët
                  </Link>
                  <Link to={`/dashboard/gamedesign/edit_employee/` + e.worker_id} className="btn btn-info btn-sm me-2">
                    Edit
                  </Link>
